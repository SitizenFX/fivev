...
public class StandaloneGeometryBakingContext implements IGeometryBakingContext {
    ...
    public static final class Builder {
        private static final Material NO_MATERIAL = new Material(InventoryMenu.BLOCK_ATLAS, MissingTextureAtlasSprite.getLocation());
        ...
        public Builder withTextures(Map<String, ResourceLocation> textures, ResourceLocation defaultTexture) {
            return withTextures(InventoryMenu.BLOCK_ATLAS, textures, defaultTexture);
        }
